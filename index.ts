...
let addNumber = (n1: number, n2: infoType, n3: number): any => {
...
const result  : {serialNumber : number;userName : string}[] = students.map((student : infoType, i : number) : {serialNumber : number;userName : string} => {
    return {
        serialNumber : i,
